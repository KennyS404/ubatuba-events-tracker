...
import { Calendar, MapPin, Tag, PenSquare, Image, AlertCircle, ArrowLeft } from 'lucide-react'
...
export default function EventForm({ darkMode }: EventFormProps) {
